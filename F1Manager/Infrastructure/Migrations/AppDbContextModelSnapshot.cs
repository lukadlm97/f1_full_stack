...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ConstructorsPowerUnits.ConstructorPowerUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsFabricConnection")
                        .HasColumnType("bit");

                    b.Property<int>("PowerUnitSupplierId")
                        .HasColumnType("int");

                    b.Property<DateTime>("StartDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("YearEstaminate")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PowerUnitSupplierId");

                    b.ToTable("ConstructorPowerUnits");
                });
            ...
            modelBuilder.Entity("Domain.PoweUnitSupplier.PowerUnitSupplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Season.Season", b =>
                {
                    ...
                    b.Property<int>("RacingChampionshipId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RacingChampionshipId");

                    b.ToTable("Seasons");
                });

            modelBuilder.Entity("Domain.TechnicalStaff.TechnicalStaff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.TechnicalStaffRole.TechnicalStaffRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.ConstructorsPowerUnits.ConstructorPowerUnit", b =>
                {
                    ...
                    b.HasOne("Domain.PoweUnitSupplier.PowerUnitSupplier", "PowerUnitSupplier")
                        .WithMany()
                        .HasForeignKey("PowerUnitSupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Constructor");

                    b.Navigation("PowerUnitSupplier");
                });
            ...
            modelBuilder.Entity("Domain.ConstructorsStaffContracts.ConstructorsStaffContracts", b =>
                {
                    ...
                    b.Navigation("TechnicalStaffRole");
                });
